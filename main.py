...
def watch_ad_2_handler(message):
    ...
    text_msg = (
        ...
        "🔗 লিংক ক্লিক করার পর কিছু ভেরিফাই কমপ্লিট করবেন আর বাটনে ক্লিক করলে অ্যাড আসলে ব্যাক বাটনে ব্যাক করে আবার ক্লিক করবেন তারপর ইউটিউবে আপনাকে নিয়ে যাবে একটা স্ক্রিনশট নিবেন আপনার কাজ শেষ তারপর বটে ফিরে আসবেন স্ক্রিনশট টি দিবেন ✅\n\n"
...
def watch_ad_3_handler(message):
    ...
    # এখানে জিরো-উইথ স্পেস ব্যবহার করা হয়েছে যাতে টেলিগ্রাম লিংক না ধরে
    text_msg = (
